...
<body onload="initialize()" class="home">
	...
	<div class="jumbotron top-space">
      ...
      <form action="process_booking.php" method="post">
               <h3><b>Seat Quantity:</b></h3> <select class="form-control" name="quantity" id="quantity">
                ...
                <br>
                <h3><b>Air Conditioning:</b></h3> <select class="form-control" name="ac" id="ac">
