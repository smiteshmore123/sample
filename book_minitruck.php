...
// [END region_geolocation]
	...
	<title>Transmego | Book a mini truck</title>
	...
	<div class="jumbotron top-space">
		<div class="container">
			<center><div class="col-lg-12 text-center">
                <h1>Selected Type: Mini Truck</h1>
                <p class="lead">&nbsp;</p>
            </div>
			<center><div class="col-lg-12 text-center">
      ...
      <form action="process_booking.php" method="post">
                ...
                <option value="Mahindra MAXIMO">Mahindra MAXIMO</option>
                 <option value="PICKUP 8 ft">PICKUP 8 ft</option>
                <option value="Tata ACE">Tata ACE</option>
                <option value="Tata APE">Tata APE</option>
