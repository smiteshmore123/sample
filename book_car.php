...
<body onload="initialize()" class="home">
	...
	<div class="jumbotron top-space">
      ...
      <form action="estimation.php" method="post">
                ...
                <option value="Maruti Suzuki SWIFT DESIRE">Maruti Suzuki SWIFT DESIRE</option>
                <option value="Maruti Suzuki SWIFT HATCHBACK">Maruti Suzuki SWIFT HATCHBACK</option>
