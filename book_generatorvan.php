<?php
session_start();
$_SESSION['category']="generator van";
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
// [END region_geolocation]
	...
	<title>Transmego | Book a generator van</title>
	...
	<div class="jumbotron top-space">
		<div class="container">
			<center><div class="col-lg-12 text-center">
                <h1>Selected Type: Generator Van</h1>
                <p class="lead">&nbsp;</p>
            </div>
			<center><div class="col-lg-12 text-center">
                <h3>Select Time Requirement:</h3>
                <p class="lead">&nbsp;</p>
            </div>
      ...
      <form action="process_booking.php" method="post">
                ...
                <option value="Upto 5 Hours">Upto 5 Hours</option>
