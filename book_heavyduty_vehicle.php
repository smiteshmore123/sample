<?php
session_start();
$_SESSION['category']="heavyduty vehicle";
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
// [END region_geolocation]
	...
	<title>Transmego | Book a heavy duty vehicle</title>
	...
	<div class="jumbotron top-space">
		<div class="container">
			<center><div class="col-lg-12 text-center">
                <h1>Selected Type: Heavy Duty Vehicle</h1>
                <p class="lead">&nbsp;</p>
            </div>
			<center><div class="col-lg-12 text-center">
      ...
      <form action="process_booking.php" method="post">
                ...
                <option value="Pokland">Pokland</option>
